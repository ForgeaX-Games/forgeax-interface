// packages/interface/src/core/extensions/foundation-panels.ts
import type { AppHost, AppExtension } from '../app-shell/types';
...
export const foundationPanelsExtension: AppExtension & {
