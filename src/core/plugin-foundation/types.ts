// packages/interface/src/core/plugin-foundation/types.ts
//
...
// `plugin-foundation/types.ts` — see docs/comm-mechanism-analysis-2026-07-09.md
...
export interface PluginManifest<C extends string, Ctx = unknown> {
