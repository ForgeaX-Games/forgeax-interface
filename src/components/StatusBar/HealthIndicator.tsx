 ...
 * the chip opens / focuses that Info panel (reusing APP_EVENTS.openPanel).
 *
...
/** Open (or focus) the standalone Info dock panel. */
function openInfoPanel(): void {
  window.dispatchEvent(new CustomEvent(APP_EVENTS.openPanel, { detail: { id: 'info' } }));
}
